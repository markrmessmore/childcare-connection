          ...
          <v-layout row wrap>
            ...
            <v-flex xs5 offset-xs1>
              <v-select
                ...
                :items="locationItems"
                v-model="applicant.secondaryWork.type"
                label="Type of Location"
              ></v-select>
            </v-flex>
            <v-flex xs4>
              <v-select
                ...
                :items="locationStatus"
                v-model="applicant.secondaryWork.status"
                label="Employment Status"
              ></v-select>
            </v-flex>
            <v-flex xs3 offset-xs1>
          ...
          <v-layout row wrap>
            ...
            <v-flex xs5 offset-xs1>
              <v-select
                ...
                :items="locationItems"
                v-model="coapplicant.primaryWork.type"
                label="Type of Location"
              ></v-select>
            </v-flex>
            <v-flex xs4>
              <v-select
                ...
                :items="locationStatus"
                v-model="coapplicant.primaryWork.status"
                label="Employment Status"
              ></v-select>
            </v-flex>
            <v-flex xs3 offset-xs1>
          ...
          <v-layout row wrap>
            ...
            <v-flex xs5 offset-xs1>
              <v-select
                ...
                :items="locationItems"
                v-model="coapplicant.secondaryWork.type"
                label="Type of Location"
              ></v-select>
            </v-flex>
            <v-flex xs4>
              <v-select
                ...
                :items="locationStatus"
                v-model="coapplicant.secondaryWork.status"
                label="Employment Status"
              ></v-select>
            </v-flex>
            <v-flex xs3 offset-xs1>
